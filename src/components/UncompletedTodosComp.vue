  ...
  <div class="mt-8">
    ...
    >
      ...
      <div class="flex items-center my-auto row-reverse text-right">
        <div class="w-10 mb-2 mr-3 text-mako-200 opacity-80 text-[10px] sm:text-[12px]">
          {{ getFormatDate(todo.updated_at) }}
        </div>
        <Menu as="div" class="relative inline-block">
          <MenuButton class="block">
            <i
              class="fi fi-sr-menu-dots text-mako-200 hover:text-mako-50 hover:text-opacity-60"
            ></i>
          </MenuButton>
